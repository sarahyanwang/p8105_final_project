...
### ANOVA Test - whether month and weekday are associated with parking violation

As from the data visualization, we observe patterns for the parking violation number over month and over weekday. In order to go more about how month and weekday are associated with the frequency of parking violation. We try to use an ANOVA test for weekday and month. 
...
$H_1:$ there exists at least one borough is different. 
...
### Proportion Test - whether proportions of the population receiving fire hydrant parking violations in each borough are equal
