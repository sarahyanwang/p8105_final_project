...
Our project focuses on the NYC parking violations, we want to investigate the association between parking violation, time, location and fine and penalty cost in 2020 and 2021.
...
* analyze total fine amount and average fine amount for type of violation

* make a map showing the location of violation and number of violation in each county
