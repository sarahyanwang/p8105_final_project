...
#### Distribution of number of violation

This bar graph shows the frequency of tickets in five boroughs in 2021. Brooklyn has the greatest number of tickets among five boroughs. Staten Island has the lowest number of tickets in 2021.
(Insert the code)


The bar graph further break down the number of tickets in five borough from January to October in 2021. There is sharp increasing of number of tickets in October.
(Insert the code)


Exploratory analysis from Sarah
