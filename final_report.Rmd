...
=======
>>>>>>> a69040eb743de561dc10ba0c032dd1b2e5e0bbf4
```

&nbsp;

### Motivation
One of our group members' had the unfortunate experience of getting her car towed last year, due to parking near by a fire hydrant in Minnesota. A [news report](https://nypost.com/2021/11/18/these-are-the-worst-nyc-streets-for-getting-a-parking-ticket/) published by New York Post about locations drivers were most likely to get a parking ticket in NYC between October 2020 and September 2021. Thus, we were intrigued by the potential of investigating parking violations in NYC in 2021, with a particular interest in fire hydrant parking violations. 
...
In order to have a better understanding of the data sets and trends of parking violations in the city may follow, we conducted some exploration mainly through visualization.
